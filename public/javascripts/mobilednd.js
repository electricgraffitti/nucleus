(function($)
{
	...
	$.fn.mobiledraganddrop = function (settings) {
		...
		return this.each(function () {
			...
			selectorForDropZones = "." + config.classmodifier + "drop";
			$(config.targets).addClass(config.classmodifier + "drop");
			
			//dragSelector = "." + config.classmodifier + "drag";
			selectorForDraggables = "." + config.classmodifier + "drag";
			$(this).addClass(config.classmodifier + "drag");
			...
			$(selectorForDraggables).live("mousedown", function() {
				var id = "#" + $(this).attr("id");
			...
			$(selectorForDropZones).live("mouseup", function () {
				var id = "#" + $(this).attr("id");
