var drag = {
  ...
  setupDashboardPanels: function(a,b,c) {
	...
	providerActionDrag: function(a,b,c) {
		// set the Selector
    var ss = a;
    // console.log(a);
    // set cookie name
    ...
    ss.sortable({
      ...
      opacity : 0.3,
      cursor: "move",
      update: function() { drag.setProviderActionOrder(ss,scn,sce); }
    });
	},
  ...
  setDashboardLaunchOrder: function(ss,scn,sce) {
	...
	setProviderActionOrder: function(ss,scn,sce) {
		$.cookie(scn, ss.sortable("toArray"), {expires: sce, path:"/"});
	},
  ...
  loadQuickLaunchOrder: function(ss,scn) {
	...
	loadProviderActionOrder: function(ss,scn) {
    var list = ss;
